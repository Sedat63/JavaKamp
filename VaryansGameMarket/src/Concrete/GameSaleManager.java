...
public class GameSaleManager implements GameSaleService {
	...
	double fiyat = game.getGamePrice() - (game.getGamePrice() * campaign.getCampaignDiscount() / 100 ); 
		...
		System.out.println(player.getFirstName() + " oyuncusuna " + game.getGamePrice() + " deðerindeki " + 
	game.getGameName() + " adlý oyun " + campaign.getCampaignName() + " kampanyasý kapsamýnda yüzde " + 
